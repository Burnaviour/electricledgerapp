...
export default function UpdateUserData() {
  ...
  return (
    ...
    <Welcome>
      <WelcomeText> 
          <HeadTiltle>Update User</HeadTiltle>
          <HeadTiltle2>Update users data.</HeadTiltle2>
      </WelcomeText>
      ...
      <Container1>
        ...
        {/* <Correction>Sub Text</Correction> */}
        <DataRow>
        <DataLabel  htmlFor="uid">User ID</ DataLabel>
        <br></br>
        <DataText1
          type="text"
